...
object ServaPreferences {
     ...
     */
    fun setFPPOverridesServaWebGLEnabled(
        context: Context,
        isEnabled: Boolean,
    ) {
        val settings = context.settings()

        settings.ironfox.fppOverridesServaWebGLEnabled = isEnabled
    }
     ...
     * @param context The application context
     */
    fun isFPPOverridesServaWebGLEnabled(
        context: Context
    ): Boolean = context.settings().ironfox.fppOverridesServaWebGLEnabled
     ...
     */
    fun setFPPOverridesServaEnabled(
        context: Context,
        isEnabled: Boolean,
    ) {
        val settings = context.settings()

        settings.ironfox.fppOverridesServaEnabled = isEnabled
    }
     ...
     * @param context The application context
     */
    fun isFPPOverridesServaEnabled(
        context: Context
    ): Boolean = context.settings().ironfox.fppOverridesServaEnabled
     ...
     */
    fun setFPPOverridesServaTimezoneEnabled(
        context: Context,
        isEnabled: Boolean,
    ) {
        val settings = context.settings()

        settings.ironfox.fppOverridesServaTimezoneEnabled = isEnabled
    }
     ...
     * @param context The application context
     */
    fun isFPPOverridesServaTimezoneEnabled(
        context: Context
    ): Boolean = context.settings().ironfox.fppOverridesServaTimezoneEnabled
     ...
     */
    fun setServaOnboardingCompleted(
        context: Context,
        isCompleted: Boolean,
    ) {
        val settings = context.settings()
     ...
     * @param context The application context
     */
    fun isServaOnboardingCompleted(
        context: Context
