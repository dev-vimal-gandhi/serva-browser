...
import com.servalabs.browser.utils.FenixSettingsDictionary
 ...
 */
class ServaSettings(private val context: Context) : PreferencesHolder {
    ...
    var fppOverridesServaEnabled by booleanPreference(
        key = context.getPreferenceKey(FenixSettingsDictionary.fppOverridesServaEnabled),
        default = true,
    )

    var fppOverridesServaTimezoneEnabled by booleanPreference(
        key = context.getPreferenceKey(FenixSettingsDictionary.fppOverridesServaTimezoneEnabled),
        default = true,
    )

    var fppOverridesServaWebGLEnabled by booleanPreference(
        key = context.getPreferenceKey(FenixSettingsDictionary.fppOverridesServaWebGLEnabled),
        default = true,
    )
