...
object FenixSettingsVisibilityManager {
    ...
    internal fun hideLocalAddonInstall(
        ...
        localAddonInstallPreference?.isVisible = ServaPreferences.isXPInstallEnabled(context) && ServaPreferences.shouldShowSecretDebugMenuThisSession(context)
    }
    ...
    internal fun hideEme(
        ...
        emeSiteSettingPreference?.isVisible = ServaPreferences.isEMEEnabled(context)
    }
